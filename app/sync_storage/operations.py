# app/sync_storage/operations.py
...
class StorageOperations:
    """
    Low-level synchronous S3 operations for interacting with object storage.
    ...
    @staticmethod
    def upload(bucket_name: str, storage_key: str, file_path: str) -> None:
        """
        ...
        client.upload_file(Filename=file_path, Bucket=bucket_name, Key=storage_key)

    @staticmethod
    def download(bucket_name: str, storage_key: str, file_path: str) -> None:
        """
        ...
        client = get_sync_client()
        client.download_file(Bucket=bucket_name, Key=storage_key, Filename=file_path)

    @staticmethod
    def delete(bucket_name: str, storage_key: str) -> None:
        """
    ...
    @staticmethod
    def head_object(bucket_name: str, storage_key: str) -> dict[str, Any]:
        """
        ...
        client = get_sync_client()
        return client.head_object(Bucket=bucket_name, Key=storage_key)
    ...
    @staticmethod
    def generate_presigned_get_url(bucket_name: str, storage_key: str, expires: int) -> str:
        """
