...
class FileService:
    ...
    resource cleanup and thread safety. Input data is assumed to be pre-validated by Pydantic schemas.
    ...
    def get(self, request: GetFileRequest) -> dict[str, Any]:
        """
        ...
        ----------
        storage_key : str
            The key of the object to inspect. Must not be empty or blank.
    ...
    def get_all(self, max_keys: int = 100) -> list[dict[str, Any]]:
        """
