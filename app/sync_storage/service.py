...
class StorageService:
    """
    Synchronous service for managing file operations on S3-compatible object storage.
    ...
    as a logical namespace for storage-related business logic.
    """
    ...
    @staticmethod
    def upload_temp(request: UploadFileRequest) -> None:
        """
        ...
        StorageService._validate_file_path(request.file_path)
    ...
    @staticmethod
    def upload_permanent(request: UploadFileRequest) -> None:
        """
    ...
    @staticmethod
    def download(storage_key: str, file_path: str) -> None:
        """
    ...
    @staticmethod
    def get_metadata(storage_key: str) -> dict[str, Any]:
        """
        ...
        return StorageOperations.head_object(
            bucket_name=minio_config.bucket_name,
            storage_key=storage_key,
        )

    @staticmethod
    def generate_presigned_put_url_temp(storage_key: str, content_type: str, expires: int) -> str:
        """
        ...
        return StorageOperations.generate_presigned_put_url(
            bucket_name=minio_config.bucket_name,
    ...
    @staticmethod
    def generate_presigned_put_url_permanent(storage_key: str, content_type: str, expires: int) -> str:
        """
    ...
    @staticmethod
    def generate_presigned_get_url(storage_key: str, expires: int) -> str:
        """
        ...
        StorageOperations.head_object(
            bucket_name=minio_config.bucket_name,
            storage_key=storage_key,
        )

        return StorageOperations.generate_presigned_get_url(
            bucket_name=minio_config.bucket_name,
            storage_key=storage_key,
            expires=expires,
        )